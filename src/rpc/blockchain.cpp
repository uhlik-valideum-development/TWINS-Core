...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zvalideumObj.push_back(Pair(to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zvalideumObj.push_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
    result.push_back(Pair("zTFsupply", zvalideumObj));
...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in valideum\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        ...
        /*    "  \"zTFsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zTF denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zTF denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zTF denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zTF denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zTF denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zTF denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zTF denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zTF denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zTF denominations\n"
            "  }\n"
            "}\n"
           */
            "\nResult (for verbose=false):\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of valideum addresses\n"
            "     \"valideumaddress\"   	 	(string) valideum address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
