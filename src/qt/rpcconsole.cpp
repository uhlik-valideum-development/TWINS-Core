                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzTFPathCustom = GetArg("-zvalideumbackuppath", "");
    ...
    if(!strzTFPathCustom.empty()) {
        ui->wallet_customzvalideumbackuppath->setText(QString::fromStdString(strzTFPathCustom));
        ui->wallet_customzvalideumbackuppath_label->setVisible(true);
        ui->wallet_customzvalideumbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzTFPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the TF RPC console.") + "<br>" +
