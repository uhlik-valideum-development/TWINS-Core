                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("VALIDEUM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TF address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and valideum: URIs)"));
...
/*    privacyAction = new QAction(QIcon(":/icons/privacy"), tr("&Privacy"), this);
    privacyAction->setStatusTip(tr("Privacy Actions for zTF"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VALIDEUM Core"), this);
    aboutAction->setStatusTip(tr("Show information about VALIDEUM Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for TF"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TF addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TF addresses"));
    ...
    openAction->setStatusTip(tr("Open a TF: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the VALIDEUM Core help message to get a list with possible TF command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("VALIDEUM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TF network", "", count));
}
...
{
    QString strTitle = tr("VALIDEUM Core"); // default title
