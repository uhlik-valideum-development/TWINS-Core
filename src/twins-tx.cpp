...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("VALIDEUM Core valideum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  valideum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded valideum transaction") + "\n" +
                               "  valideum-tx [options] -create [commands]   " + _("Create hex-encoded valideum transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded valideum transaction
