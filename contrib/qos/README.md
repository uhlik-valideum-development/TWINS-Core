...
This means one can have an always-on valideumd instance running, and another local valideumd/valideum-qt instance which connects to this node and receives blocks from it.
