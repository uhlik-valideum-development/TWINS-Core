...
In order to support loading of multiple wallets in valideum-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is valideum.cpp.
...
Changes to valideum.cpp
----------------------
valideum.cpp is the entry point into valideum-qt, and as such, will require some minor modifications to provide hooks for
