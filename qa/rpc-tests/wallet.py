...
#   c) node1 mines 32 blocks, so now node 0 has 60001valideum, node 1 has 4250valideum, node2 has none.
#   d) node0 sends 601 valideum to node2, in two transactions (301 valideum, then 300 valideum).
