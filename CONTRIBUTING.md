Contributing to VALIDEUM Core
============================

The VALIDEUM Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VALIDEUM Core project, and is not to be
confused with overall TF Network Protocol consensus changes.

Whether a pull request is merged into VALIDEUM Core rests with the project merge
...
Patches that change TF consensus rules are considerably more involved than
...
Where a patch set proposes to change the TF consensus, it must have been
...
The project leader is the release manager for each VALIDEUM Core release.
